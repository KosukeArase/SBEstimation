...
extern int nrn_get_mechtype();
 ...
 "setdata_kc_fast", _hoc_setdata,
 "settables_kc_fast", _hoc_settables,
 0, 0
};
...
#define usetable usetable_kc_fast
 double usetable = 1;
 /* some parameters have upper and lower limits */
 static HocParmLimits _hoc_parm_limits[] = {
 "usetable_kc_fast", 0, 1,
 0,0,0
};
 static HocParmUnits _hoc_parm_units[] = {
 "gbar_kc_fast", "mho/cm2",
 "ik_kc_fast", "mA/cm2",
 0,0
};
 ...
 "usetable_kc_fast", &usetable_kc_fast,
 0,0
};
	...
	Prop *_prop;
{
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_size(_mechtype, 5);
 	...
 	ivoc_help("help ?1 kc_fast /volume1/home/hp120263/k01792/workspace/github/sb_estimation/hocfile_forSB/sparc64/kc_fast.mod\n");
