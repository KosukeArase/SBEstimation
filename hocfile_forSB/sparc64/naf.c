	...
	Prop *_prop;
{
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_size(_mechtype, 4);
 	...
 	ivoc_help("help ?1 naf /volume1/home/hp120263/k01792/workspace/github/sb_estimation/hocfile_forSB/sparc64/naf.mod\n");
...
static int  _f_settables ( _p, _ppvar, _thread, _nt, _lv1 ) double* _p; Datum* _ppvar; Datum* _thread; _NrnThread* _nt; 
	double _lv1 ;
 {
   ...
   hinf = 1.0 / ( 1.0 + exp ( ( ( _lv1 + fastNa_shift * 0.0 ) + 62.9 ) / 10.7 ) ) ;
   htau = 0.15 + 1.15 / ( 1.0 + exp ( ( ( _lv1 + fastNa_shift * 0.0 ) + 37.0 ) / 15.0 ) ) ;
    return 0; }
