...
#define h _mlhh
 ...
 static int _hoc_fran();
 static int _hoc_fseed();
 static int _hoc_norm();
 static int _hoc_n_rand();
 static int _hoc_poisint();
 static int _hoc_pois();
 static int _hoc_u_rand();
	...
	Prop *_prop;
{
 ...
 _rand_reg() {
  ...
  _initlists();
 	...
 	ivoc_help("help ?1 rand /volume1/home/hp120263/k01792/workspace/github/sb_estimation/hocfile_forSB/sparc64/rand.mod\n");
 }
static int _reset;
