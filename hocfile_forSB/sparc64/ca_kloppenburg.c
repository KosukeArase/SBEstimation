...
extern int nrn_get_mechtype();
 ...
 "setdata_ca_kloppenburg", _hoc_setdata,
 "rates_ca_kloppenburg", _hoc_rates,
 0, 0
};
...
#define usetable usetable_ca_kloppenburg
 double usetable = 1;
 /* some parameters have upper and lower limits */
 static HocParmLimits _hoc_parm_limits[] = {
 "usetable_ca_kloppenburg", 0, 1,
 0,0,0
};
 static HocParmUnits _hoc_parm_units[] = {
 "gcabar_ca_kloppenburg", "mho/cm2",
 0,0
};
 ...
 "usetable_ca_kloppenburg", &usetable_ca_kloppenburg,
 0,0
};
	...
	Prop *_prop;
{
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_size(_mechtype, 4);
 	...
 	ivoc_help("help ?1 ca_kloppenburg /volume1/home/hp120263/k01792/workspace/github/sb_estimation/hocfile_forSB/sparc64/ca_kloppenburg.mod\n");
...
static int _reset;
static char *modelname = "Calcium current from kloppenburg_horner_1998";
...
static int  _f_rates ( _p, _ppvar, _thread, _nt, _lv ) double* _p; Datum* _ppvar; Datum* _thread; _NrnThread* _nt; 
 ...
 {
   double _ltmp ;
 _ltmp = exp ( - ( _lv + 17.0 ) / 4.0 ) ;
   minf = 1.0 / ( 1.0 + _ltmp ) ;
   _ltmp = exp ( ( _lv + 22.0 ) / 14.0 ) ;
   mtau = ( 32.0 / ( 1.0 + _ltmp ) ) + 1.8 ;
   _ltmp = exp ( ( _lv + 30.0 ) / 12.0 ) ;
   hinf = 1.0 / ( 1.0 + _ltmp ) ;
   htau = 3.0 * mtau ;
    return 0; }
