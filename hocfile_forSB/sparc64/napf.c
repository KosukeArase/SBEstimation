...
extern int nrn_get_mechtype();
 ...
 "setdata_napf", _hoc_setdata,
 "settables_napf", _hoc_settables,
 0, 0
};
	...
	Prop *_prop;
{
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_size(_mechtype, 4);
 	...
 	ivoc_help("help ?1 napf /volume1/home/hp120263/k01792/workspace/github/sb_estimation/hocfile_forSB/sparc64/napf.mod\n");
