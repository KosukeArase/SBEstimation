	...
	Prop *_prop;
{
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 GABAA /volume1/home/hp120263/k01792/workspace/github/sb_estimation/hocfile_forSB/sparc64/gabaa.mod\n");
 ...
 v=_v;
{
 ...
 for (; t < _break; t += dt) {
 error =  state();
 if(error){fprintf(stderr,"at line 44 in file gabaa.mod:\n	SOLVE state METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
