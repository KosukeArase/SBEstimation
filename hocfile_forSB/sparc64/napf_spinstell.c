...
extern int nrn_get_mechtype();
 ...
 "setdata_napf_spinstell", _hoc_setdata,
 "settables_napf_spinstell", _hoc_settables,
 0, 0
};
...
#define usetable usetable_napf_spinstell
 double usetable = 1;
 /* some parameters have upper and lower limits */
 static HocParmLimits _hoc_parm_limits[] = {
 "usetable_napf_spinstell", 0, 1,
 0,0,0
};
 static HocParmUnits _hoc_parm_units[] = {
 "fastNa_shift_napf_spinstell", "mV",
 "a_napf_spinstell", "1",
 "b_napf_spinstell", "1",
 "c_napf_spinstell", "1",
 "d_napf_spinstell", "1",
 "gbar_napf_spinstell", "mho/cm2",
 "ina_napf_spinstell", "mA/cm2",
 "minf_napf_spinstell", "1",
 "mtau_napf_spinstell", "ms",
 "df_napf_spinstell", "mV",
 0,0
};
 ...
 "usetable_napf_spinstell", &usetable_napf_spinstell,
 0,0
};
	...
	Prop *_prop;
{
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_size(_mechtype, 4);
 	...
 	ivoc_help("help ?1 napf_spinstell /volume1/home/hp120263/k01792/workspace/github/sb_estimation/hocfile_forSB/sparc64/napf_spinstell.mod\n");
...
static int _reset;
static char *modelname = "Sodium persistent current for RD Traub et al 2003, 2005";
...
static int  _f_settables ( _p, _ppvar, _thread, _nt, _lv1 ) double* _p; Datum* _ppvar; Datum* _thread; _NrnThread* _nt; 
	double _lv1 ;
 {
   minf = 1.0 / ( 1.0 + exp ( ( - ( _lv1 + fastNa_shift ) - 38.0 ) / 10.0 ) ) ;
   if ( ( _lv1 + fastNa_shift ) < - 30.0 ) {
     mtau = 0.025 + 0.14 * exp ( ( ( _lv1 + fastNa_shift ) + 30.0 ) / 10.0 ) ;
     }
   else {
     mtau = 0.02 + a + ( 0.145 + b ) * exp ( ( - ( _lv1 + fastNa_shift + d ) - 30.0 ) / ( 10.0 + c ) ) ;
     }
    return 0; }
