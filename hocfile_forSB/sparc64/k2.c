	...
	Prop *_prop;
{
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_size(_mechtype, 4);
 	...
 	ivoc_help("help ?1 k2 /volume1/home/hp120263/k01792/workspace/github/sb_estimation/hocfile_forSB/sparc64/k2.mod\n");
...
static int _reset;
static char *modelname = "Potasium Type K2 current for RD Traub, J Neurophysiol 89:909-921, 2003";
...
static int  _f_settables ( _p, _ppvar, _thread, _nt, _lv ) double* _p; Datum* _ppvar; Datum* _thread; _NrnThread* _nt; 
	double _lv ;
 {
   minf = 1.0 / ( 1.0 + exp ( ( - _lv - 10.0 ) / 17.0 ) ) ;
   mtau = 4.95 + 0.5 / ( exp ( ( _lv - 81.0 ) / 25.6 ) + exp ( ( - _lv - 132.0 ) / 18.0 ) ) ;
   hinf = 1.0 / ( 1.0 + exp ( ( _lv + 58.0 ) / 10.6 ) ) ;
   htau = 60.0 + 0.5 / ( exp ( ( _lv - 1.33 ) / 200.0 ) + exp ( ( - _lv - 130.0 ) / 7.1 ) ) ;
    return 0; }
