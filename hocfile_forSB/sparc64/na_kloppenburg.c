...
extern int nrn_get_mechtype();
 ...
 "setdata_na_kloppenburg", _hoc_setdata,
 "rates_na_kloppenburg", _hoc_rates,
 0, 0
};
...
#define usetable usetable_na_kloppenburg
 double usetable = 1;
 /* some parameters have upper and lower limits */
 static HocParmLimits _hoc_parm_limits[] = {
 "usetable_na_kloppenburg", 0, 1,
 0,0,0
};
 static HocParmUnits _hoc_parm_units[] = {
 "gnabar_na_kloppenburg", "mho/cm2",
 0,0
};
 ...
 "usetable_na_kloppenburg", &usetable_na_kloppenburg,
 0,0
};
	...
	Prop *_prop;
{
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_size(_mechtype, 4);
 	...
 	ivoc_help("help ?1 na_kloppenburg /volume1/home/hp120263/k01792/workspace/github/sb_estimation/hocfile_forSB/sparc64/na_kloppenburg.mod\n");
...
static int _reset;
static char *modelname = "Sodium current from kloppenburg_horner_1998";
...
static int  _f_rates ( _p, _ppvar, _thread, _nt, _lv ) double* _p; Datum* _ppvar; Datum* _thread; _NrnThread* _nt; 
 ...
 {
   double _ltmp ;
 _ltmp = exp ( - ( _lv + 40.0 ) / 5.0 ) ;
   minf = 1.0 / ( 1.0 + _ltmp ) ;
   _ltmp = exp ( ( _lv + 23.0 ) / 6.5 ) ;
   mtau = ( ( 6.5 / ( 1.0 + _ltmp ) ) + 0.9 ) * 5.0 ;
   _ltmp = exp ( ( _lv + 45.0 ) / 15.0 ) ;
   hinf = 1.0 / ( 1.0 + _ltmp ) ;
   _ltmp = exp ( ( _lv + 20.0 ) / 8.0 ) ;
   htau = ( ( 1.3 / ( 1.0 + _ltmp ) ) + 0.49 ) * 5.0 ;
    return 0; }
