...
#define t _nt->_t
#define dt _nt->_dt
#define shift_mnaf_init _p[0]
#define shift_mnaf_run _p[1]
#define shift_hnaf _p[2]
#define gbar _p[3]
#define shift_mnaf _p[4]
#define ina _p[5]
#define minf _p[6]
#define hinf _p[7]
#define mtau _p[8]
...
extern int nrn_get_mechtype();
 ...
 "setdata_naf_tcr", _hoc_setdata,
 "settables_naf_tcr", _hoc_settables,
 0, 0
};
...
#define usetable usetable_naf_tcr
 double usetable = 1;
 /* some parameters have upper and lower limits */
 static HocParmLimits _hoc_parm_limits[] = {
 "usetable_naf_tcr", 0, 1,
 0,0,0
};
 static HocParmUnits _hoc_parm_units[] = {
 "shift_mnaf_init_naf_tcr", "mV",
 "shift_mnaf_run_naf_tcr", "mV",
 "shift_hnaf_naf_tcr", "mV",
 "gbar_naf_tcr", "mho/cm2",
 "shift_mnaf_naf_tcr", "mV",
 "ina_naf_tcr", "mA/cm2",
 "minf_naf_tcr", "1",
 "hinf_naf_tcr", "1",
 "mtau_naf_tcr", "ms",
 ...
 "usetable_naf_tcr", &usetable_naf_tcr,
 0,0
};
...
#define _cvode_ieq _ppvar[3]._i
 ...
 "6.2.0",
"naf_tcr",
 "shift_mnaf_init_naf_tcr",
 "shift_mnaf_run_naf_tcr",
 "shift_hnaf_naf_tcr",
 "gbar_naf_tcr",
 0,
 "shift_mnaf_naf_tcr",
	...
	Prop *_prop;
{
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_size(_mechtype, 4);
 	...
 	ivoc_help("help ?1 naf_tcr /volume1/home/hp120263/k01792/workspace/github/sb_estimation/hocfile_forSB/sparc64/naf_tcr.mod\n");
...
static int _reset;
static char *modelname = "Sodium transient current for RD Traub et al 2003, 2005";
...
static int  _f_settables ( _p, _ppvar, _thread, _nt, _lv1 ) double* _p; Datum* _ppvar; Datum* _thread; _NrnThread* _nt; 
	double _lv1 ;
 {
   ...
   minf = 1.0 / ( 1.0 + exp ( ( - ( _lv1 + shift_mnaf ) - 38.0 ) / 10.0 ) ) ;
   if ( ( _lv1 + shift_mnaf ) < - 30.0 ) {
     mtau = 0.025 + 0.14 * exp ( ( ( _lv1 + shift_mnaf ) + 30.0 ) / 10.0 ) ;
     }
   else {
     mtau = 0.02 + ( 0.145 ) * exp ( ( - ( _lv1 + shift_mnaf ) - 30.0 ) / 10.0 ) ;
     }
   hinf = 1.0 / ( 1.0 + exp ( ( _lv1 + shift_hnaf + 62.9 ) / 10.7 ) ) ;
   htau = 0.15 + 1.15 / ( 1.0 + exp ( ( _lv1 + 37.0 ) / 15.0 ) ) ;
    return 0; }
