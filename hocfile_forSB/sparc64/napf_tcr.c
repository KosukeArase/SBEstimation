...
extern int nrn_get_mechtype();
 ...
 "setdata_napf_tcr", _hoc_setdata,
 "settables_napf_tcr", _hoc_settables,
 0, 0
};
...
#define usetable usetable_napf_tcr
 double usetable = 1;
 /* some parameters have upper and lower limits */
 static HocParmLimits _hoc_parm_limits[] = {
 "usetable_napf_tcr", 0, 1,
 0,0,0
};
 static HocParmUnits _hoc_parm_units[] = {
 "fastNa_shift_napf_tcr", "mV",
 "a_napf_tcr", "1",
 "b_napf_tcr", "1",
 "c_napf_tcr", "1",
 "d_napf_tcr", "1",
 "gbar_napf_tcr", "mho/cm2",
 "ina_napf_tcr", "mA/cm2",
 "minf_napf_tcr", "1",
 "mtau_napf_tcr", "ms",
 "df_napf_tcr", "mV",
 ...
 "usetable_napf_tcr", &usetable_napf_tcr,
 0,0
};
	...
	Prop *_prop;
{
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_size(_mechtype, 4);
 	...
 	ivoc_help("help ?1 napf_tcr /volume1/home/hp120263/k01792/workspace/github/sb_estimation/hocfile_forSB/sparc64/napf_tcr.mod\n");
