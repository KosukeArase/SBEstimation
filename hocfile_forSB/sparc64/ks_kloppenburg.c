...
extern int nrn_get_mechtype();
 ...
 "setdata_ks_kloppenburg", _hoc_setdata,
 "rates_ks_kloppenburg", _hoc_rates,
 0, 0
};
...
#define usetable usetable_ks_kloppenburg
 double usetable = 1;
 /* some parameters have upper and lower limits */
 static HocParmLimits _hoc_parm_limits[] = {
 "usetable_ks_kloppenburg", 0, 1,
 0,0,0
};
 static HocParmUnits _hoc_parm_units[] = {
 "gkbar_ks_kloppenburg", "mho/cm2",
 0,0
};
 ...
 "usetable_ks_kloppenburg", &usetable_ks_kloppenburg,
 0,0
};
	...
	Prop *_prop;
{
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_size(_mechtype, 4);
 	...
 	ivoc_help("help ?1 ks_kloppenburg /volume1/home/hp120263/k01792/workspace/github/sb_estimation/hocfile_forSB/sparc64/ks_kloppenburg.mod\n");
...
static int _reset;
static char *modelname = "Sustained potassium current from kloppenburg_horner_1998";
...
static int  _f_rates ( _p, _ppvar, _thread, _nt, _lv ) double* _p; Datum* _ppvar; Datum* _thread; _NrnThread* _nt; 
 ...
 {
   double _ltmp ;
 _ltmp = exp ( - ( _lv + 15.2 ) / 33.4 ) ;
   minf = 1.0 / ( pow( ( 1.0 + _ltmp ) , 3.0 ) ) ;
   _ltmp = exp ( ( _lv - 10.0 ) / 17.0 ) ;
   mtau = 1.6 + ( 10.0 / ( 1.0 + _ltmp ) ) ;
    return 0; }
