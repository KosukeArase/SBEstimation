	...
	Prop *_prop;
{
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_size(_mechtype, 4);
 	...
 	ivoc_help("help ?1 kdr /volume1/home/hp120263/k01792/workspace/github/sb_estimation/hocfile_forSB/sparc64/kdr.mod\n");
...
static int _reset;
static char *modelname = "Potasium dr type current for RD Traub, J Neurophysiol 89:909-921, 2003";
...
static int  _f_settables ( _p, _ppvar, _thread, _nt, _lv ) double* _p; Datum* _ppvar; Datum* _thread; _NrnThread* _nt; 
	double _lv ;
 {
   minf = 1.0 / ( 1.0 + exp ( ( - _lv - 29.5 ) / 10.0 ) ) ;
   if ( _lv < - 10.0 ) {
